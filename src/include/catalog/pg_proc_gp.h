...
DATA(insert OID = 5082 ( asin  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_asin _null_ _null_ _null_ n a ));
DESCR("asin");

/* atan(complex) => complex */
DATA(insert OID = 5083 ( atan  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_atan _null_ _null_ _null_ n a ));
DESCR("atan");

/* cos(complex) => complex */
DATA(insert OID = 5084 ( cos  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_cos _null_ _null_ _null_ n a ));
DESCR("cos");
