...
PG_KEYWORD("cube", CUBE, COL_NAME_KEYWORD) /* GPDB_95_MERGE_FIXME: UNRESERVED_KEYWORD? */
...
PG_KEYWORD("rollup", ROLLUP, COL_NAME_KEYWORD) /* GPDB_95_MERGE_FIXME: UNRESERVED_KEYWORD? */
PG_KEYWORD("rootpartition", ROOTPARTITION, UNRESERVED_KEYWOR)
...
PG_KEYWORD("sets", SETS, COL_NAME_KEYWORD) /* GPDB_95_MERGE_FIXME: UNRESERVED_KEYWORD? */
...
PG_KEYWORD("sql", SQL, UNRESERVED_KEYWORD)             /* GPDB_95_MERGE_FIXME: SQL -> SQL_P?  */
