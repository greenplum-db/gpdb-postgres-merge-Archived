...
PG_KEYWORD("cube", CUBE, COL_NAME_KEYWORD) /* FIXME: UNRESERVED_KEYWORD? */
...
PG_KEYWORD("rollup", ROLLUP, COL_NAME_KEYWORD) /* FIXME: UNRESERVED_KEYWORD? */
...
PG_KEYWORD("sets", SETS, COL_NAME_KEYWORD) /* FIXME: UNRESERVED_KEYWORD? */
...
PG_KEYWORD("sql", SQL, UNRESERVED_KEYWORD)             /* GPDB: FIXME: SQL_P?  */
