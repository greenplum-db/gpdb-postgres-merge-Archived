		...
		DispatchCommandQueryParms *pQueryParms, int *finalLen)
{
	...
	const char *sqdesc = pQueryParms->serializedQueryDispatchDesc;
	int sqdesc_len = pQueryParms->serializedQueryDispatchDesclen;
