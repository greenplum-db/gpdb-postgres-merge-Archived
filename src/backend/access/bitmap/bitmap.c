...
#if 0
	/* GPDB_96MERGE_FIXME
	 * Each kind of access method should provide a validate callback function
	 * for bitmap I can not find one.
	 * Just give a function framework, we should implement one before 96 merge
	 * into master.
	 */
